...
badgePaas: label="PaaS" type="Informative" url="https://experienceleague.adobe.com/sv/docs/commerce/user-guides/product-solutions" tooltip="Gäller endast Adobe Commerce i molnprojekt (Adobe-hanterad PaaS-infrastruktur) och lokala projekt."
badgeSaas: label="SaaS" type="Positive" url="https://experienceleague.adobe.com/sv/docs/commerce/user-guides/product-solutions" tooltip="Gäller endast Adobe Commerce as a Cloud Service- och Adobe Commerce Optimizer-projekt (SaaS-infrastruktur som hanteras av Adobe)."
...
Beta-program för [Adobe Commerce produktlösningar](https://experienceleague.adobe.com/sv/docs/commerce/user-guides/product-solutions) är ett sätt för handlare att få tillgång till förhandsversionsfunktioner och -kod, ge feedback och vägleda framtiden för Adobe Commerce. Det finns två typer av betaprogram:
...
Denna funktion förbättrar flexibiliteten och effektiviteten i försäljningen, vilket hjälper handlarna att leverera mer relevanta produktupptäckt i stor skala. Mer information finns i [försäljningsregler](https://experienceleague.adobe.com/sv/docs/commerce/optimizer/merchandising/rules/add).
...
Genom att sälja produkter i Adobe Commerce Optimizer-kategorier kan säljarna styra hur produkterna beställs på kategorisidor. Marknadsförare konfigurerar beteendet som en **kategoriregel** i arbetsflödet för försäljningsregler, tillsammans med [sökregler och standardregler för produktlistor](https://experienceleague.adobe.com/sv/docs/commerce/optimizer/merchandising/rules/overview). Varje regel kan kombinera **intelligent rankning** (beteendesignaler och AI där det är tillämpligt), valfri **prisbaserad sortering** och **manuell** åtgärder som att fästa, lyfta och begrava - så att teamen kan strukturera identifieringen, köra kampanjer och justera kategorisidor med strategi utan externa verktyg.

**Viktiga fördelar**

- Använd en eller flera kategorier med samma regelbaserade arbetsflöde som används för sökning och standardlistor.
- Ordna kategorilistor med hjälp av intelligenta rankningsstrategier (till exempel de mest visade, mest köpta, lägg till i kundvagnen, personaliserade rekommendationer, trender) plus valfri prissortering.
- Layer manual pin, boost, and bury actions on top of intelligent ranking when you need precise placement.
- Omfångsregler efter katalogvy när konfigurationen använder flera katalogvyer.

Mer information finns i [Kategorimarknadsföring](https://experienceleague.adobe.com/sv/docs/commerce/optimizer/merchandising/rules/add).
