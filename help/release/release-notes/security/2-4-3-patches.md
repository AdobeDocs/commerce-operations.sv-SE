...
Den senaste informationen om säkerhetsfelkorrigeringarna finns i [Adobe säkerhetsbulletin APSB21-86](https://helpx.adobe.com/se/security/products/magento/apsb21-86.html). Korrigeringsversionen innehåller även felkorrigeringar för leverantörsutvecklade tillägg för [Braintree](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/payments/braintree.html?lang=sv-SE), [Klarna](https://commercemarketplace.adobe.com//klarna-m2-klarna.html) och [Vertex](https://commercemarketplace.adobe.com//vertexinc-vertex-tax-module.html) .
