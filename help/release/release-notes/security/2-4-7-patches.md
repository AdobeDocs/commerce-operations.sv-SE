...
Den här versionen innehåller stöd för Adobe Commerce [HIPAA-klart tillägg](https://experienceleague.adobe.com/sv/docs/commerce-admin/start/compliance/hipaa-ready-service/overview).
