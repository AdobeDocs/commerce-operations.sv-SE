...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
              <li><!--LYNX-730-->Lagringskonfigurationer för katalogprisregler har lagts till, frågan <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/all-rules/"><code>allCatalogRules</code></a> har lagts till för att hämta alla tillgängliga katalogregler, och fältet <code>Product.rules</code> visas för att visa katalogregler som för närvarande tillämpas på en produkt.</li>
