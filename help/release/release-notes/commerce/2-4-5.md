...
**Problem**: Etiketter för mellanlagrade försäljningsregler kan inte matchas efter en uppgradering till Adobe Commerce 2.4.6 eller senare från versioner före 2.4.5. **Tillfällig lösning**: Använd ACSD-50625_2.4.5-P1.patch under uppgraderingen före steget Uppdatera metadata. Se [salesRules-etikettproblem vid uppgradering från versioner &lt; 2.4.5](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/salesRule-labels-upgrade-from-versions-under-2.4.5.html) Kunskapsbasartikeln.

Allmänna åtgärder för att lösa problemet:

1. Ladda ned patchen. Se [salesRules-etikettproblem vid uppgradering från versioner &lt; 2.4.5](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/salesRule-labels-upgrade-from-versions-under-2.4.5.html) Kunskapsbasartikeln.
2. Följ uppgraderingsstegen som beskrivs i fasen Hantera paket i uppgraderingsprocessen [Uppgradera](https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/implementation/perform-upgrade.html).
