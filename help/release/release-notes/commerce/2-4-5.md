...
Adobe Commerce har förbättrat plattformskvalitet, betalningsmetoder, GraphQL-cache och tillgänglighet. Den innehåller uppdateringar av integrerade Google-moduler och verktyget för kompatibilitetsuppgradering och introducerar stöd för Live Search B2B.
...
* The `bin/magento config:set graphql/session/disable 1` Med kommandot kan handlare helt inaktivera skapandet av sessionscookies för alla GraphQL-åtgärder. Som standard skapar Adobe Commerce dessa cookies och förlitar sig på dem för auktorisering, vilket påverkar prestandan. Framöver rekommenderar vi att du använder variabler som den enda typen av auktorisering för GraphQL-begäranden. Vi rekommenderar inte att du använder sessionscookies separat eller tillsammans med auktoriseringstoken. Se [GraphQL-auktorisering](https://devdocs.magento.com/guides/v2.4/graphql/authorization-tokens.html). <!-- B2B-2204 -->
...
* Adobe Commerce-sessioner avslutas inte längre efter att en GraphQL-begäran har gjorts. Tidigare `ClearCustomerSessionAfterRequest` plugin-programmet loggade ut till shopparen. [GitHub-34550](https://github.com/magento/magento2/issues/34550)
