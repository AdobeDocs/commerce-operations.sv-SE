...
* **Önsklistorna**. [mutationen addWishlistItemsToCart](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-wishlist-items-to-cart.html) flyttar objekt från den angivna önskelistan till kundens kundvagn. <!-- magento/partners-magento2ee#449-->

* **Presentregister**. De uppgifter som omfattas är: <!-- PWA-1290-->

   * Använd [presentRegistry-frågan](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry.html) för att returnera innehållet i kundens presentregister.

   * Sök efter presentregister efter [typ](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-type-search.html), [e-post](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-email-search.html) eller [ID](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-id-search.html).

   * [Skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-gift-registry.html), [uppdatera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry.html) eller [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry.html) presentregister.

   * [Uppdatera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-items.html) eller [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-items.html) objekt från ett presentregister.

   * [Flytta alla artiklar](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-cart-items-to-gift-registry.html) från vagnen till presentregistret. <!-- ENGCOM-9082 9087-->
...
* **Förhandlingsbara citattecken**. Se [`negotiableQuote`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quote.html)- och [`negotiableQuotes`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quotes.html)-frågorna. <!-- PWA-1292-->
...
* Du kan nu lägga till en anpassad fältmappning för Elasticsearch i `Magento\Elasticsearch\Model\Adapter\FieldMapper\Product\FieldProvider\FieldName\Resolver\CompositeResolver`. [GitHub-24350](https://github.com/magento/magento2/issues/24350)
