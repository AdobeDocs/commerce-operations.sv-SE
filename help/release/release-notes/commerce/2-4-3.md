...
* **Önsklistorna**. [mutationen addWishlistItemsToCart](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-wishlist-items-to-cart.html) flyttar objekt från den angivna önskelistan till kundens kundvagn. <!-- magento/partners-magento2ee#449-->

* **Presentregister**. De uppgifter som omfattas är: <!-- PWA-1290-->

   * Använd [presentRegistry-frågan](https://developer.adobe.com/commerce/webapi/graphql/queries/gift-registry.html) för att returnera innehållet i kundens presentregister.

   * Sök efter presentregister efter [typ](https://developer.adobe.com/commerce/webapi/graphql/queries/gift-registry-type-search.html), [e-post](https://developer.adobe.com/commerce/webapi/graphql/queries/gift-registry-email-search.html) eller [ID](https://developer.adobe.com/commerce/webapi/graphql/queries/gift-registry-id-search.html).

   * [Skapa](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-gift-registry.html), [uppdatera](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-gift-registry.html) eller [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-gift-registry.html) presentregister.

   * [Uppdatera](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-gift-registry-items.html) eller [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-gift-registry-items.html) objekt från ett presentregister.

   * [Flytta alla artiklar](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-cart-items-to-gift-registry.html) från vagnen till presentregistret. <!-- ENGCOM-9082 9087-->

   * [Lägg till](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-gift-registry-registrants.html), [uppdatera](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-gift-registry-registrants.html) eller [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-gift-registry-registrants.html) registranter från ett presentregister.

   * [Dela](https://developer.adobe.com/commerce/webapi/graphql/mutations/share-gift-registry.html) ett presentregister med inbjudna.

* **Förhandlingsbara citattecken**. Se [`negotiableQuote`](https://developer.adobe.com/commerce/webapi/graphql/queries/negotiable-quote.html)- och [`negotiableQuotes`](https://developer.adobe.com/commerce/webapi/graphql/queries/negotiable-quotes.html)-frågorna. <!-- PWA-1292-->
