...
* **3DS-stöd för[!DNL Google Pay]** - Inkluderat stöd för 3DS-verifiering för [!DNL Google Pay] icke-tokeniserade kort. Mer information finns i [Braintree-dokumentationen](https://developer.paypal.com/braintree/docs/guides/3d-secure/advanced-options/javascript/v3#verify-google-pay-card-using-3ds).
...
* Rubriken X-Magento-Cache-Id har tagits bort från GraphQL mutationssvar. Eftersom mutationer är föränderliga åtgärder (som att lägga till artiklar i kundvagnen eller lägga en order) ska de inte cachelagras. Att ta med den här rubriken var vilseledande och kan leda till felaktigt beteende om cachelagring används. Ändringen är anpassad efter GraphQL bästa praxis och grundprinciperna för Adobe Commerce arkitektur.
