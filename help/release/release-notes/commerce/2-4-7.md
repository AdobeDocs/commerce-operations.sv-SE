...
Vår teknikstack bygger på PHP och MySQL. Mer information finns i [Systemkrav](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html?lang=sv-SE).

## Installations- och uppgraderingsanvisningar

Du kan installera Adobe Commerce 2.4.7 med [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html?lang=sv-SE).
