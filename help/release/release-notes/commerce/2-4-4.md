...
* The `Magento\Framework\MessageQueue\TopologyTest` test är nu kompatibelt med AWS MQ för tjänsten RabbitMQ. Tidigare misslyckades testet med följande meddelande: `Invalid exchange configuration: magento-topic-based-exchange1 Failed asserting that two arrays are equal`. <!-- AC-1248-->
