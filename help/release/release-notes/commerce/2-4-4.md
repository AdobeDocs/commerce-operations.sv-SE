...
Läs [Adobe säkerhetsbulletin](https://helpx.adobe.com/se/security/products/magento/apsb22-13.html) för den senaste informationen om dessa åtgärdade problem.
