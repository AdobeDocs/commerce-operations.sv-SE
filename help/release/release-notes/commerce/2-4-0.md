...
**I den här versionen har integreringen av betalningsmetoden Authorize.Net, Way, CyberSource och Worldplay tagits bort från kärnkoden. Merchants ska migrera till de officiella tilläggen som är tillgängliga på Commerce Marketplace**.
...
**Arbetsflödesfunktion för ordergodkännande för B2B**. Med ordergodkännanden kan chefer för inköpsorganisationer konfigurera godkännanderegler för sina köpare. Se [Godkännanderegler](https://docs.magento.com/user-guide/customers/account-dashboard-approval-rules.html). Funktioner:
...
Det här paketerade tillägget ersätter vår integrering med Braintree, som har tagits bort i den här versionen. Se [Braintree-betalningar](https://marketplace.magento.com/paypal-module-braintree.html).
...
* GETEN `V1/orders/:orderId` returnerar presentkortskoder som förväntat.
...
* CMS-sidändringar loggas nu som förväntat i åtgärdsloggen. MFTF täcker nu den här funktionen.  _Korrigering har skickats av Lukasz Bajsarowicz i pull-begäran [27597](https://github.com/magento/magento2/pull/27597)_. [GitHub-171](https://github.com/magento/magento2/issues/171)
