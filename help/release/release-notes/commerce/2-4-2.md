...
* Möjligheten att konfigurera en installation att använda en delad databas har tagits bort i den här versionen. Se [Borttagning av delade databasfunktioner i Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog-inlägg.
...
**Problem**: Köpare dirigeras om till kundvagnen när de försöker göra en beställning från en inköpsorder med PayPal Express Checkout när **Sammanhangsberoende läge** är inaktiverat. <!-- B2B-1604-->
...
**Problem**: Rabatterna för en viss betalningsmetod gäller fortfarande vid utcheckning av en inköpsorder även när köparen ändrar sin betalningsmetod under den slutliga utcheckningen. Det innebär att kunderna kan få en rabatt som de inte har rätt till. Detta beror på att en kundvagnsregel för den ursprungliga betalningsmetoden fortfarande används trots att betalningsmetoden har ändrats. **Tillfällig lösning**: Ingen. Se [2.4.2 Känt fel B2B: Rabatten gäller fortfarande för onlineinköpsorder när betalningsmetoden har ändrats](https://support.magento.com/hc/en-us/articles/360054667312) Kunskapsbasartikeln. <!-- B2B-1012 -->

**Problem**: `deleteRequisitionListOutput` frågan returnerar information om den borttagna rekvisitionslistan i stället för de återstående rekvisitionslistorna. <!-- MC-39894-->
