...
Adobe Commerce 2.4.2 innehåller förbättringar av prestanda och säkerhet samt betydande plattformsförbättringar. Säkerhetsförbättringarna inkluderar utökat stöd för `SameSite` attribut för alla cookies. B2B-förbättringarna fokuserar på stöd för onlinebetalningar för inköpsorder. Stöd finns nu för Elasticsearch 7.9.x och Redis 6.x.
...
* Överträdelser av CSP (Core Content Security Policy) har åtgärdats.
...
* 2.4.2 har testats med [Varnish 6.4](../../../installation/system-requirements.md). Version 2.4.x är fortfarande kompatibel med Varnish 6.x.
...
* Stöd för flera önskelistor har lagts till. Du kan använda GraphQL för att [skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-wishlist.html), [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-wishlist.html)och [byt namn](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-wishlist.html) önskelistor [move](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-products-between-wishlists.html) eller [copy](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-products-between-wishlists.html) objekt mellan dem. <!-- MC-32356-->

* Stöd för returnerad varuauktorisering (RMA) har lagts till. Shoppare kan [begära retur](https://devdocs.magento.com/guides/v2.4/graphql/mutations/request-return.html). Om handlaren accepterar begäran kan han/hon utföra uppgifter som [lägga till en kommentar](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-comment.html) och [lägg till spårningsinformation](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

* Stöd för följande B2B-funktioner:
   * Företag. Du kan lägga till företag [administratörer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company.html), [användare](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-user.html), [roller](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-role.html)och [team](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   * Företagskrediter. The [företagsfråga](https://devdocs.magento.com/guides/v2.4/graphql/queries/company.html) innehåller information om företagets kredithistorik. <!-- MC-33862-->
   * Rekvisitionslistor. Du kan [skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-requisition-list.html), [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list.html)och [uppdatera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-requisition-list.html) rekvisitionslistor. Support innefattar även möjligheten att [add](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-requisition-list.html), [uppdatera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-products-in-wishlist.html), [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list-items.html), [copy](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-items-between-requisition-lists.html)och [move](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-items-between-requisition-lists.html) artiklar i en rekvisitionslista samt lägga till rekvisitionslisteartiklar [i varukorgen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

* Stöd för fackföreningar i GraphQL har lagts till. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Stöd för [jämförelselistor](https://devdocs.magento.com/guides/v2.4/graphql/queries/compare-list.html). Shoppare kan [skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-compare-list.html) och [delete](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-compare-list.html) jämförelselistor, och [add](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-compare-list.html) och [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-products-from-compare-list.html) objekt i jämförelselistorna. Dessutom kan kunder som skapar en jämförelselista som gäst logga in som kund och [behåll](https://devdocs.magento.com/guides/v2.4/graphql/mutations/assign-compare-list-to-customer.html) jämförelselistor.
...
2.4.2 introducerar B2B v1.3.1. Den här versionen innehåller stöd för onlinebetalningar för inköpsorder samt flera felkorrigeringar.

**Inköpsorder kan nu slutföras med onlinebetalningsmetoder**. B2B-köpare uppmanas att välja sin betalningsmetod för varje [inköpsorder](https://docs.magento.com/user-guide/stores/b2b-purchase-order-flow.html) under den första utcheckningen. När inköpsordern har godkänts uppmanas köparna att ange betalningsinformation för att konvertera inköpsordern till en slutgiltig order.
...
* Introducerar `Approved – Pending Payment` ange för inköpsorder att tydligt visa när åtgärd krävs.
...
I den här versionen av PWA Studio ingår följande:
...
* Utvecklare kan nu formatera olika typer av utdata i olika visningsrutor utan att använda `!important` -direktivet.

* Innehåll som migreras till Page Builder fylls inte längre ut med standardformat för infogad text.

* Page Builder kräver inte längre att alla innehållstyper placeras i en rad. The [Page Builder-scen](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#stage) är nu tomt från början och har stöd för att lägga till följande innehållstyper direkt på scenen: Rader, kolumner, flikar, HTML-kod, block, dynamiska block.

* Fördefinierade marginaler och utfyllnader behövs inte längre för innehållstyper.

* Den nya mobilen [visningsruteväljare](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#viewports) och visningsomfång för formulärfältvärden gör att användare och utvecklare kan utföra följande åtgärder:
...
* [Amazon Pay](https://docs.magento.com/user-guide/payment/amazon-pay.html). Amazon Pay har tagits bort i den här versionen och kommer att tas bort i Magento 2.5.0. Version 2.4.3 och senare kommer endast att innehålla uppdateringar för kompatibilitet och korrigeringar för större fel.
...
* Möjligheten att konfigurera en installation att använda en delad databas har tagits bort i den här versionen. Se [Borttagning av delade databasfunktioner i Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog post.
...
* The **Lägg till ny klassificering** och **Spara**, **Ta bort**, **Återställ** knapparna är inte längre tillgängliga på **Lager** > **Attribut** > **Klassificering** sida för en administratör med begränsad behörighet.
...
* Administratörer vars behörigheter exkluderar `Magento_Catalog::edit_product_design` (Redigera produktdesign) kan nu skapa en ny produkt genom att spara en befintlig produkt med ett nytt namn i den valda butiksvyn. Tidigare visades följande fel i programmet:  `Not allowed to edit the product's design attributes`. [GitHub-28106 ](https://github.com/magento/magento2/issues/28106)

<!-- MC-36406-->

* Programmet visar inte längre **Lägg till attribut** knapp på sidor under **Lager** > Attribut när en administratör saknar tillräcklig behörighet för att skapa de här entiteterna. Tidigare inträffade ett 404-fel i programmet när en webbplatsadministratör som inte hade tillräcklig behörighet försökte skapa en **Attributuppsättning** eller **Kund** -attribut.

<!-- ENGCOM-8230 -->

* Programmet genererar inte längre något fel när du försöker ändra `backend-frontname` med `ssh` efter installation av Adobe Commerce. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Betalningsmetoden PayPal Express Checkout fungerar nu som väntat med betalningsmetoden Braintree-kreditkort. Tidigare visades inte programmet **PayPal** när betalningsmetoden för kreditkort på Braintree har aktiverats.
...
* Sidan Skapa orderfaktura visar nu de underordnade produkterna för paketprodukter som förväntat. [GitHub-27350](https://github.com/magento/magento2/issues/27350)
...
* Programmet visar nu informativa felmeddelanden när du överför en CSV-fil som innehåller flera typer av fel när du lägger till produkter i kundvagnen. Tidigare visade programmet en tom sida och ett generiskt felmeddelande när du klickade **Välj fil** på **Hantera kundvagn** > **Lägg i kundvagnen per SKU**.
...
* Den sekvens i vilken katalogbehörigheter konfigureras förhindrar inte längre administratörer med rätt behörigheter att lägga till produkter i kundvagnen. Tidigare kunde programmet inte verifiera `addToCart` konfigurationsinställningar för den aktuella kundgruppen. Därför uppstod ett fel när en administratör försökte lägga till en produkt i kundvagnen.
...
* Åtgärdade problem med designen av `AdminMediaGalleryInsertLargeImageFileSizeTest`.
...
* Tillämpa en prisregel med en kupong med GraphQL fungerar nu som väntat när **Fast beloppsrabatt för hela kundvagn** används.
...
* Programmet uppdaterar nu attribut som är etiketterade `Product Type`. Tidigare `product_type` -attributet var reserverat i koden. Programmet visade det här meddelandet när du försökte uppdatera ett `Product Type` attribute: `An attribute with the same code (product_type) already exists.`
...
* The **Lägg i kundvagnen** fungerar nu som väntat när **Lägg i kundvagnen** knappen finns tillgänglig för att klicka. Om du tidigare klickade på den här knappen flera gånger i väntan på att en produktsida skulle läsas in uppstod följande fel: `Invalid Form Key. Please refresh the page`.
...
* Filtrering av katalogprodukter i **Alla butiksvyer** omfånget fungerar nu korrekt. Tidigare produkter med statusen `Enabled` eller `Disabled` visades i rutnätet när endast aktiverade eller inaktiverade produkter filtrerades.
...
* Poster tas nu bort som förväntat när du tar bort ett objekt från en webbplats. Tidigare duplicerades bilder vid POST `rest/all/V1/products` utfördes.
...
* Handlarna kan nu spara ett nytt attribut när produkten skapas. Tidigare sparade inte programmet attributet och omdirigerade handlaren till butiksvyns hemsida när de försökte spara attributet. [GitHub-30362](https://github.com/magento/magento2/issues/30362)
...
* Produktdatabasen använder nu `store_id` när det är tillgängligt för att spara attributvärden för en befintlig produkt.  Tidigare åsidosatte produktdatabasklassen produktens butiks-ID och tilldelade alltid standardbutiks-ID:t. [GitHub-29933](https://github.com/magento/magento2/issues/29933)
...
* Korrigerade en parallalisering av&quot;artikel&quot; i ordersammanfattningen för minikundvagnen och kassan. [GitHub-29920](https://github.com/magento/magento2/issues/29920)
...
* En överflödig fältuppsättning i försäljningsregelformuläret har tagits bort. [GitHub-29599](https://github.com/magento/magento2/issues/29599)
...
* Oanvända parametrar i konstruktionen av `AdvancedPricing` har tagits bort. [GitHub-29531](https://github.com/magento/magento2/issues/29531)
...
* Programmet konverterar nu oformaterad text korrekt till HTML när du klickar **Returnera HTML-version** när du läser in en e-postmall.
...
* Programmet dirigerar inte längre om kunder till hemsidan när butiksvyn ändras. The `\Magento\VersionsCmsUrlRewrite\Model\StoreSwitcher::switch()` metoden dirigerar nu om kunderna till hemsidan endast när `$urlPath` finns inte för den andra butiksvyn.
...
* Programmet tolkar nu korrekt text som innehåller `}}` i widgetinnehållsfältet. [GitHub-12087](https://github.com/magento/magento2/issues/12087)
...
* The `FlushCacheByTags` klassen har uppdaterats för att använda after-plug-ins i stället för omkring-plug-ins. [GitHub-29558](https://github.com/magento/magento2/issues/29558)

<!-- ENGCOM-8358 -->

* `MessageValidator` fungerar inte längre på hash-matriser som inte innehåller en `0` -element. [GitHub-30563](https://github.com/magento/magento2/issues/30563)
...
* Generatorn för URL-omskrivning anger nu kategoriobjektet `url_key`, `url_path`och  `store_id` till standardvärden för lagring när kategori-URL sparas för det globala omfånget. Tidigare sparades den `url_key`, `url_path`och `store_id` med värdena för det senast bearbetade lagrings-ID:t. [GitHub-29585](https://github.com/magento/magento2/issues/29585)
...
* Överflödig hash med `req.http.host/client.ip` har tagits bort och hash hanteras av den inbyggda VCL:en för lack. [GitHub-29988](https://github.com/magento/magento2/issues/29988)
...
* E-postmeddelanden som innehåller en presentkortskod skickas nu först när ordern har sparats när **Skapa ett presentkortskonto när en orderartikel beställs** konfigurationsinställningen är aktiverad. Tidigare återanvändes en presentkortskod och skickades till olika kunder om ett presentkortskonto genererades när artiklarna beställdes, men ett undantag inträffade efter att det virtuella presentkortet skickades.

<!-- MC-36496-->

* Programmet duplicerar inte längre presentkortsbeställningar. Tidigare levererades två presentkoder när en köpare beställde ett presentkort. Detta inträffade på grund av `cron` jobb anropade `\Magento\GiftCard\Observer\GenerateGiftCardAccountsInvoice::execute()`och den här metoden kontrollerar inte om presentkortskoder redan har genererats när fakturor skapades.

<!-- MC-35058-->

* Merchants kan nu ta bort produkttilldelning från kategorier som förväntat. Tidigare uppstod ett fel som liknar det här felet: `Could not save product "4" with position 0 to category 3`.
...
* Google Tag Manager `productClick` fungerar nu som förväntat. Tidigare `productClick` aktiverades inte för produkter på listsidor och Google Tag Manager kunde inte fånga den händelsen.

<!-- MC-38781-->

* De konfigurerbara produktalternativen för Google Tag Manager uppdateras nu som väntat i datalagret när du har redigerat en konfigurerbar produkt i kundvagnen. Tidigare har data för `removeFromCart` händelsen skrevs om felaktigt när produktalternativet ändrades och kvantiteten förblev densamma.
...
* Svarstiden för GraphQL för tillägg till kundvagnsåtgärder har förbättrats.
...
* GraphQL hanterar nu katalogbehörigheter. Programmet begränsar vilka objekt som returneras för en `products` fråga baserat på kundens kundgrupp.
...
* Bilder visas nu av Catalog Events Carousel-widgeten efter överföring som förväntat. Tidigare `catalog_event_status_checker` cron-jobbet tog bort överförda bilder.
...
* En schemalagd produktimportprocess uppdaterar nu produkter med korrekta datafält när CSV-filen även innehåller felaktiga poster. Tidigare uppdaterades inga poster om CSV-filen innehöll felaktiga poster när **Vid fel: Fortsätt bearbetningen** har aktiverats.
...
* Vi har förbättrat prestandan för den partiella indexeraren. Programmet rensar nu cache-ID:n som ändrats för varje batchiteration på 1000 ID. Cachekontext ackumulerar inte längre ID:n. Tidigare samlade cachekontext in-ID:n för varje batchiteration på 1000-ID och rensade samma uppsättning ID:n för varje iteration.
...
* Du kan nu använda `app/etc/env.php` om du vill ändra meddelandehanteraren från MYSQL till AMQP.
...
* A `head.additional` textblock `\Magento\Framework\View\Element\Text\ListText` har lagts till i `adminhtml` `default` layout (efter `magento2/module-base`). [GitHub-29165](https://github.com/magento/magento2/issues/29165)
...
* Ett problem med `StorefrontProductListWidgetWithSharedCatalogTest` som gjorde att testet hoppades över har åtgärdats. [GitHub-322](https://github.com/magento/partners-magento2b2b/issues/322)
...
* Betydande titlar och beskrivningar har lagts till i MFTF-testerna för `Company`, `CompanyCredit`, `CompanyPayment`, `CompanyShipping`och `ConfigurableSharedCatalog` moduler. [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* Programmet visar inte längre `Purchase Order number is a required field` meddelandet ovanför kupongkodsfältet innan kunden anger någon information i distributioner där Inköpsorder har konfigurerats som det enda tillgängliga betalningsalternativet.
...
* Gästkunder kan nu göra PayPal-beställningar när **Automatisk tilldelning till kundgrupp** är aktiverat. Betalningen behandlas på PayPal-gatewayen, ordern skapas i Magento och kunden ser din tacksida. Tidigare bearbetades beställningen på PayPal-gatewayen, men beställningen skapades inte i Adobe Commerce. Köparen omdirigerades istället till sidan för ordergranskning där följande fel visades i programmet: `Failed address validation: %1" error`. [GitHub-25399](https://github.com/magento/magento2/issues/25399)

#### PayPal

<!-- MC-35692-->

* Handlare kan nu göra en beställning från administratören efter att ha bytt från en betalningsmetod som använder ett kreditkort till en betalningsmetod som inte är kreditkort. Tidigare när en handlare klickade på **Skicka beställning** startades inläsningsprocessen men slutfördes inte och ordningen placerades inte.

<!-- MC-37649-->

* Programmet skapar inte längre dubblettorder när en order placeras med PayPal Express. Tidigare när en kund försökte betala för en beställning med PayPal Express men PayPal returnerade ett fel, skapades beställningen ändå. Detta resulterade i dubblettorder på handlarens webbplats. [GitHub-13952](https://github.com/magento/magento2/issues/13952)
...
* **Rapporter** > **Marknadsföring** > **Produkter i kartor** visar nu bara posten i det tillåtna omfånget för den användare som genererar rapporten. Tidigare fanns alla data tillgängliga för alla scope.
...
* Du kan nu ta bort spårnings- och leveransinformation för en RMA när JavaScript-paketering är aktiverat.
...
* Antalet klassificeringar som visas på **Lager** > **Attribut** > **Klassificering** matchar nu antalet klassificeringar i en driftsättning på flera platser. [GitHub-30258](https://github.com/magento/magento2/issues/30258)

<!-- MC-37117-->

* Sidan Ny granskning läses nu in som förväntat när du klickar på **Ny granskning** på Admin **Marknadsföring** > **Alla granskningar**. Om du klickar på en produkt på den här sidan öppnas det förväntade nya granskningsformuläret för den produkten.
...
* Programmet visar inte längre det här felet när en kund återanvänder belöningspunkter efter att ha tagit bort dem: `You removed the reward points from this order`.
...
* Elasticsearch genererar inte längre ett okänt modifieringsfel när en kund söker på en söksynonym. Tidigare saknade escape-symboler i reguljära uttryck, vilket resulterade i ett allvarligt fel.
...
* Skicka 0 med `/rest/V1/products/special-price-information` slutpunkten för specialpris sparar nu priset och returnerar schemat som förväntat.
...
* Omlagda produktändringar tas inte längre bort efter en `cron` kör.

<!-- MC-38759-->

* Programmet genererar inte längre något fel när du försöker schemalägga en uppdatering för en kategori. Tidigare inträffade det här felet i programmet när du klickade **Spara** på sidan Schedule New Update: `Something went wrong while saving the Magento\Catalog\Api\Data\CategoryInterface`.

<!-- MC-38455-->

* The `rest/V1/products/special-price` API kan nu användas för att schemalägga specialpriser för flera butiker. Tidigare uppstod ett fel när en handlare schemalade en prisuppdatering för flera butiker för samma `from` och `to` den tidpunkt då en återställning är tillgänglig vid starttiden för det nya schemat.
...
* Målreglerna för relaterade produkter fungerar nu när `is one of` villkor som används för funktionen Produkter att visa innehåller flera villkor. Tidigare parsades det inte om villkoret innehöll flera värden.
...
* `bin/magento dev:tests:run` startar nu följande tester som förväntat: all, unit, integration, integration-all, static, static-all, integrity, legacy och default.
...
* Markörens position har justerats från mitten till början av **Meddelande** fält på **Mitt konto** > **Presentregister** > **Dela presentregister**.
...
* Programmet visar nu en kalenderikon bredvid **Datum** inmatningsfältet som väntat på butiken Skapa en kontosida.
...
* Den banderoll som programmet visas på sidan Administratörsinloggning som kund finns nu längst upp på sidan när användaren rullar. [GitHub-29354](https://github.com/magento/magento2/issues/29354)
...
* Programmet visar nu de valda alternativen för konfigurerbara produktattribut på önskelistsidan som förväntat. [GitHub-24091](https://github.com/magento/magento2/issues/24091),  [GitHub-22503](https://github.com/magento/magento2/issues/22503)
...
**Problem**: The `[magento_root]/index.php` filen har tagits bort och programmet körs nu från `/pub` som standard för Apache-konfigurationer. Lager som hanteras från undermappar fungerar inte som förväntat och kan visa 404 fel. **Tillfällig lösning**: Använd symboler för att emulera installationen i undermappar. I följande exempel används två butiker (`https://shop01.com/shop/` och `https://shop02.com/shop/`) för att illustrera hur du använder en länk för att emulera en installation i undermappar.
...
1. Skapa en `index.php` filen i den nya katalogen (`magento_root/pub/shop01/index.php`) och lägga till det här innehållet:
...
**Problem**: Handlare måste aktivera snabbstyrd TLS-funktionalitet från administratören för att aktivera den globala omdirigeringen HTTP till HTTPS för alla butikssidor. Se [Omdirigera HTTP till HTTPS för alla sidor i molnet (Tvinga TLS)](https://support.magento.com/hc/en-us/articles/360006296953) Kunskapsbasartikeln. <!-- MC-39988-->

**Problem**: Du kan inte använda `addConfigurableProductToCart` GraphQL-mutation för att lägga till en konfigurerbar produkt i en kundvagn i en icke-standardbutiksvy i en multibutiksdistribution som kör Inventory. (Lumabutiker påverkas inte.) programmet visar följande fel: `Could not add item to cart. Please check required options and try again`. **Tillfällig lösning**: Använd `addProductsToCart` mutation istället. [GitHub-31660](https://github.com/magento/magento2/issues/31660)<!-- PWA-1298-->

**Problem**: Programmet skickar inte in betalningsinformation som förväntat när en kund först anger rätt kod i fältet CAPTCHA på betalningssidan, men det här felet visas: `There has been an error processing your request`. Detta inträffar endast när kunden försöker att lägga ordern antingen utan att ange CAPTCHA-koden eller genom att ange den felaktigt.  **Tillfällig lösning**: Uppdatera sidan. <!-- MC-40506-->

**Problem**: Programmet skapar en order i Braintree som förväntat när en kund klickar på den **Betala med Venmo**, men skapar inte ordningen i Admin. **Tillfällig lösning**: Ingen. Se [2.4.2 Känt fel: Braintree Venmo-betalningen fungerar inte](https://support.magento.com/hc/en-us/articles/360054662652/)  Kunskapsbasartikeln.  <!-- BUNDLE-2894-->

### Kända fel - B2B

**Problem**: B2B-köpare kan använda onlinebetalningsmetoder för att kringgå det vanliga inköpsorderflödet. Detta scenario kan inträffa om köparen kan minska den totala utcheckningen till 0 (t.ex. med en kampanjkod eller presentkort) och därefter ta bort koden eller presentkortet. Även under dessa villkor beställer programmet fortfarande rätt belopp baserat på priserna för artiklarna i deras tilldelade katalog. **Tillfällig lösning**: Inaktivera presentkort och kupongkoder när online-betalningsmetoder har aktiverats för godkännande av inköpsorder. <!-- B2B-1603-->

**Problem**: Köpare dirigeras om till kundvagnen när de försöker lägga en order från en inköpsorder med PayPal Express Checkout när **Sammanhangsläge** är inaktiverat. <!-- B2B-1604-->

**Problem**: Programmet visar ibland ett 404-fel när en köpare skapar en inköpsorder och sedan navigerar till utcheckningssidan. Det här felet inträffar när en köpare tidigare har skapat en annan inköpsorder med en onlinebetalningsmetod innan han/hon går till utcheckningssidan utan att slutföra det föregående köpet. Köparen kan fortfarande göra inköpsordern. **Tillfällig lösning**: Ingen. <!-- B2B-1605-->

**Problem**: Rabatterna för en viss betalningsmetod gäller även vid utcheckning av en inköpsorder även när köparen ändrar sin betalningsmetod under den slutliga utcheckningen. Det innebär att kunderna kan få en rabatt som de inte har rätt till. Detta beror på att en kundvagnsregel för den ursprungliga betalningsmetoden fortfarande används trots att betalningsmetoden har ändrats. **Tillfällig lösning**: Ingen. Se [2.4.2 Känt fel B2B: Rabatten gäller för onlineinköpsorder när betalningsmetoden har ändrats](https://support.magento.com/hc/en-us/articles/360054667312) Kunskapsbasartikeln. <!-- B2B-1012 -->

**Problem**: The `deleteRequisitionListOutput` frågan returnerar information om den borttagna rekvisitionslistan i stället för de återstående rekvisitionslistorna. <!-- MC-39894-->
...
Du kan installera Adobe Commerce 2.4.2 med [Disposition](../../../installation/composer.md).
