...
* Stöd för flera önskelistor har lagts till. Du kan använda GraphQL för att [skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-wishlist.html), [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-wishlist.html) och [byta namn på](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-wishlist.html) önskelistor samt för att [flytta](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-products-between-wishlists.html) eller [kopiera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-products-between-wishlists.html) objekt mellan dem. <!-- MC-32356-->

* Stöd för returnerad varuauktorisering (RMA) har lagts till. Köpare kan [begära retur](https://devdocs.magento.com/guides/v2.4/graphql/mutations/request-return.html). Om handlaren accepterar begäran kan han/hon utföra uppgifter som att [lägga till en kommentar](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-comment.html) och [lägga till spårningsinformation](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->
...
* Stöd för följande B2B-funktioner:
   ...
   * Företagskrediter. [företagsfrågan](https://devdocs.magento.com/guides/v2.4/graphql/queries/company.html) innehåller information om företagets kredithistorik. <!-- MC-33862-->
   * Rekvisitionslistor. Du kan [skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-requisition-list.html), [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list.html) och [uppdatera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-requisition-list.html) rekvisitionslistor. Supporten inkluderar även möjligheten att [lägga till](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-requisition-list.html), [uppdatera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-products-in-wishlist.html), [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list-items.html), [kopiera](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-items-between-requisition-lists.html) och [flytta](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-items-between-requisition-lists.html) objekt i en rekvisitionslista samt lägga till rekvisitionslistobjekt [i kundvagnen](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

* Stöd för fackföreningar i GraphQL har lagts till. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Stöd för [jämförelselistor](https://devdocs.magento.com/guides/v2.4/graphql/queries/compare-list.html) har lagts till. Köpare kan [skapa](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-compare-list.html)- och [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-compare-list.html)-jämförelselistor och [lägga till](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-compare-list.html)- och [ta bort](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-products-from-compare-list.html)-objekt i jämförelselistorna. Dessutom kan kunder som skapar en jämförelselista som gäst logga in som kund och [behålla](https://devdocs.magento.com/guides/v2.4/graphql/mutations/assign-compare-list-to-customer.html) sina jämförelselistor.

* [`generateCustomerTokenAsAdmin`](https://devdocs.magento.com/guides/v2.4/graphql/mutations/generate-customer-token-as-admin.html)-mutationen har lagts till och `Customer`-objektet har uppdaterats med stöd för fjärrinköpshjälp.
...
* Page Builder kräver inte längre att alla innehållstyper placeras i en rad. [Page Builder-scenen](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#stage) är nu tom från början och har stöd för att lägga till följande innehållstyper direkt på scenen: Rader, kolumner, flikar, HTML-kod, block och dynamiska block.

* Fördefinierade marginaler och utfyllnader behövs inte längre för innehållstyper.

* Med den nya [visningsruteväljaren](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#viewports) för mobilen och visningsruteomfånget för formulärfältvärden kan användare och utvecklare utföra följande åtgärder:
...
* Logiken har tagits bort från WYSIWYG OnInsert-styrenheten (`Magento\Cms\Controller\Adminhtml\Wysiwyg\Images\OnInsert::execute()`) och lagts till i `Model\Wysiwyg\Images\PrepareImage::execute()`-modellen. [GitHub-1504](https://github.com/magento/adobe-stock-integration/issues/1504)
...
* Booleska värden har inte längre angetts för `image_with_border.phtml`. De överflödiga inställningarna `max-width` och `height` har tagits bort från `.product-image-photo`. (Dessa värden anges redan globalt i bilden med hjälp av de återställda stilarna.) [GitHub-30186](https://github.com/magento/magento2/issues/30186)
...
* Prestandan för katalogsökning har förbättrats. Inaktivera **Aktivera sökförslag** (**Lagrar** > **Konfiguration** > **Katalog** > **Katalogsökning** ) fungerar som förväntat. Tidigare frågade programmet om tabellen MySQL `search_query` i stället för Elasticsearch hade sökförslag för automatisk komplettering. [GitHub-25534](https://github.com/magento/magento2/issues/25534)
...
**Utgåva**: Programmet skapar en order i Braintree som förväntat när en kund klickar på **Betala med Venmo**, men skapar inte ordningen i Admin. **Tillfällig lösning**: Ingen. Se det [2.4.2 kända felet Braintree Venmo-betalningen fungerar inte i ](https://support.magento.com/hc/en-us/articles/360054662652/) kunskapsbasartikeln.  <!-- BUNDLE-2894-->
