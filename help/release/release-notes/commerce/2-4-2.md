...
* Stöd för flera önskelistor har lagts till. Du kan använda GraphQL för att [skapa](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html), [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html) och [byta namn på](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) önskelistor samt för att [flytta](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) eller [kopiera](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) objekt mellan dem. <!-- MC-32356-->

* Stöd för returnerad varuauktorisering (RMA) har lagts till. Köpare kan [begära retur](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html). Om handlaren accepterar begäran kan han/hon utföra uppgifter som att [lägga till en kommentar](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) och [lägga till spårningsinformation](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

* Stöd för följande B2B-funktioner:
   * Företag. Du kan lägga till företag [administratörer](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html), [användare](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html), [roller](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html) och [team](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   * Företagskrediter. [företagsfrågan](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) innehåller information om företagets kredithistorik. <!-- MC-33862-->
   * Rekvisitionslistor. Du kan [skapa](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html), [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html) och [uppdatera](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html) rekvisitionslistor. Supporten inkluderar även möjligheten att [lägga till](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html), [uppdatera](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html), [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html), [kopiera](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html) och [flytta](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) objekt i en rekvisitionslista samt lägga till rekvisitionslistobjekt [i kundvagnen](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

* Stöd för fackföreningar i GraphQL har lagts till. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Stöd för [jämförelselistor](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html) har lagts till. Köpare kan [skapa](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html)- och [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html)-jämförelselistor och [lägga till](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html)- och [ta bort](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html)-objekt i jämförelselistorna. Dessutom kan kunder som skapar en jämförelselista som gäst logga in som kund och [behålla](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html) sina jämförelselistor.

* [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html)-mutationen har lagts till och `Customer`-objektet har uppdaterats med stöd för fjärrinköpshjälp.
...
* Med den nya [visningsruteväljaren](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports) för mobilen och visningsruteomfånget för formulärfältvärden kan användare och utvecklare utföra följande åtgärder:
