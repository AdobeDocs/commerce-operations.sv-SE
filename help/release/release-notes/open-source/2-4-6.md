...
Stöd för PHP 7.4 har tagits bort från den här versionen. Du kan inte köra Magento Open Source på PHP 7.4.
...
* Magento Open Source returnerar nu ett informativt meddelande när en `addProductsToCart` frågan misslyckas när en produkt läggs till i kundvagnen med otillräcklig behörighet.
...
* Magento Open Source antar inte längre felaktigt att en kategori är överordnad en annan kategori baserat på kategorisökväg. [GitHub-32464](https://github.com/magento/magento2/issues/32464)
