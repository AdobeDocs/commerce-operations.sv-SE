...
Magento Open Source 2.4.2 har förbättrat prestanda och säkerhet samt gjort betydande plattformsförbättringar. Säkerhetsförbättringarna inkluderar utökat stöd för attributet `SameSite` för alla cookies. Stöd finns nu för Elasticsearch 7.9.x och Redis 6.x.
...
* Programmet genererar inte längre ett fel när du försöker ändra `backend-frontname` med behållaren `ssh` efter att ha installerat Magento Open Source. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
**Utgåva**: Programmet skapar en order i Braintree som förväntat när en kund klickar på **Betala med Venmo**, men skapar inte ordningen i Admin. Se det [2.4.2 kända felet Braintree Venmo-betalningen fungerar inte i ](https://support.magento.com/hc/en-us/articles/360054662652/) kunskapsbasartikeln.  <!-- BUNDLE-2894-->
...
Du kan installera Magento Open Source 2.4.2 med [Composer](../../../installation/composer.md).
