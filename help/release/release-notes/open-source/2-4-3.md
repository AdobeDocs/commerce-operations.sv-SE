...
* Nu visas sidelementen på samma sätt på butikssidor som använder Magento Open Source standardteman. Tidigare användes inte alla format i ett tomt tema, så alla sidelement visades inte på sidor med det här temat. (Det fanns till exempel ingen förstoringsikon i sökfältet Mina beställningar.)
