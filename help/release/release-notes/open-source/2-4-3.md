...
* [`dynamicBlocks`-frågan ](https://developer.adobe.com/commerce/webapi/graphql/queries/dynamic-blocks.html) returnerar innehållet i dynamiska block som matchar de angivna filtren.
