...
* Magento Open Source 2.4.4 har stöd för Elasticsearch 7.16 och OpenSearch 1.2. I programmet Open Source-handlare med distributioner på plats kan båda använda en lösning. OpenSearch är nu standardsökmotorn för distributioner av Magento Open Source 2.4.4 som lagras i molnet. Alla kunder med molndistributioner som uppgraderar till version 2.4.4 måste använda OpenSearch. Se [Byt till OpenSearch för Adobe Commerce i molnet 2.4.4](https://support.magento.com/hc/en-us/articles/4419942355725-Switching-to-OpenSearch-for-Adobe-Commerce-on-Cloud-2-4-4)
...
* Konfigurationen för platskartor kan nu ändras från kommandoraden. Tidigare visade programmet Open Source det här felet när du försökte ändra platskartskonfigurationen utanför Admin: `Import failed: Notice: Trying to access array offset on value of type null in app/code/Magento/Cron/Model/Config/Backend/Sitemap.php on line 78`.  [GitHub-31428](https://github.com/magento/magento2/issues/31428)
...
* Kuponggenerering blockeras nu tills den relaterade kundvagnsprisregeln sparas med `auto` aktiverat alternativ. Om du försöker spara regeln utan att aktivera `auto` -alternativet visas följande meddelande i programmet Open Source: `Rule is not saved with auto generate option enabled. Please save the rule and try again`.
...
* Administratörer med begränsade behörigheter som inkluderar beställnings- och leveransbehörigheter kan nu visa ordersidan som förväntat. Tidigare genererades ett fel i applicationOpen Source när en administratör med dessa behörigheter försökte visa en order. [GitHub-14633](https://github.com/magento/magento2/issues/14633)
...
* Magento Open Source visar inte längre något fel vid utcheckning med betalningsmetoden PayPal Express. Tidigare visades det här felet i programmet Open Source, trots att utcheckningsprocessen är slutförd: `Something went wrong`.
...
* Magento Open Source har nu **Spara** knappar och fält för automatisk komplettering när du anger en ofullständig URL när du lägger till en video (Admin **Katalog**  > **Produkter** > **Lägg till video**). Tidigare **Spara** inaktiverades och fälten fylldes inte i.
...
**Problem**: Köpare kan inte lägga till en produkt i kundvagnen när inga alternativ har valts i Admin **Butik** >  **Konfiguration** > **Allmänt** > **Alternativ för land** > **Tillåt länder**. I programmet Open Source visas i stället följande konsolfel: `Failed to load resource: the server responded with a status of 400 (Bad Request)`. <!-- AC-2564-->
