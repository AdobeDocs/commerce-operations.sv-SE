...
Med undantag av [Braintree](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/payments/braintree) har alla tillägg som paketerats av leverantörer tagits bort från kodbasen Magento Open Source 2.4.4. Handlare bör migrera till de officiella tilläggen som är tillgängliga på [Commerce Marketplace](https://marketplace.magento.com/extensions.html).
