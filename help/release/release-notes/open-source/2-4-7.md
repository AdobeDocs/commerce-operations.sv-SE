...
* The `addProductsToCart` frågan har nu lagt till ett presentkort i en kundvagn. Tidigare förväntades presentkortets mottagarnamn, men avsändarens namn returnerades i stället. Magento Open Source orsakade detta fel: `Please specify a recipient name`. [GitHub-36665](https://github.com/magento/magento2/issues/36665)
