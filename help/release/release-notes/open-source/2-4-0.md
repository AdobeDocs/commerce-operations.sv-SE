...
Mer information om den här och andra förbättringar finns i [GraphQL Developer Guide](https://developer.adobe.com/commerce/webapi/graphql/). Mer information om de senaste felkorrigeringarna för GraphQL finns i [Versionsinformation](https://developer.adobe.com/commerce/webapi/graphql/release-notes.html).
