...
* **Borttagning av kärnintegreringen av koden för det signerade bedrägeriskyddet**. Den här kärnfunktionen stöds inte längre. Merchants ska migrera till det [signerade tillägget Bedrägeri och återbetalningsskydd](https://commercemarketplace.adobe.com//signifyd-module-connect.html) som är tillgängligt på Commerce Marketplace.

* Braintree-huvudmodulen **har tagits bort från kodbasen**. Nu har Braintree Payments-modulen samma funktionsuppsättning. Se [Braintree-betalningar](https://commercemarketplace.adobe.com//paypal-module-braintree.html).
...
Det här tillägget ersätter vår integrering med Braintree. Den har samma funktioner som Braintree kärnintegration. Se [Braintree-betalningar](https://commercemarketplace.adobe.com//paypal-module-braintree.html).
...
* Det finns inte längre stöd för implementering av signering av bedrägeriskydd. Merchants ska migrera till det [signerade tillägget Bedrägeri och återbetalningsskydd](https://commercemarketplace.adobe.com//signifyd-module-connect.html) som är tillgängligt på Commerce Marketplace.
...
* Slutförda order visas nu både i betalningssystemet och i Magento Open Source. Tidigare fanns beställningar i betalningssystemet men inte i Magento Open Source. [GitHub-25862](https://github.com/magento/magento2/issues/25862)
