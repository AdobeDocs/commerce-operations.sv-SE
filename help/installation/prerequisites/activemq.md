...
>[!NOTE]
>
>ActiveMQ Artemis introducerades i Adobe Commerce 2.4.5 och senare. Mer information om hur du installerar ActiveMQ-artemis i Adobe Commerce i molninfrastrukturprojekt finns i [Konfigurera ActiveMQ-tjänsten](https://experienceleague.adobe.com/sv/docs/commerce-on-cloud/user-guide/configure/service/activemq) i *Commerce on Cloud Guide*.
