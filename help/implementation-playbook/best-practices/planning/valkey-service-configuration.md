...
>[!NOTE]
>
>I det föregående exemplet är cachen `full_page` inte relevant för Adobe Commerce i molninfrastrukturprojekt, eftersom dessa projekt använder [Fast](https://experienceleague.adobe.com/sv/docs/commerce-on-cloud/user-guide/cdn/fastly).
