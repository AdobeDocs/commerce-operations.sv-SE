---
title: Användning
description: Lär dig hur du använder verktyget Korrigeringsfiler för kvalitet för att tillämpa och hantera korrigeringsfiler för Adobe Commerce. Upptäck tekniker för testning, tillämpning och korrigeringshantering.
...
Titta på den här [tekniska videon](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/tools/quality-patch-tool.html) och lär dig hur du använder verktyget för kvalitetskorrigeringar för Adobe Commerce.
