...
description: MDVA-42790-korrigeringen åtgärdar ett problem där användare inte kan uppdatera produktprisattribut för specifika webbplatser via REST API. Den här korrigeringen är tillgänglig när [QPT-verktyget (Quality Patches Tool)](https://experienceleague.adobe.com/sv/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.11 är installerat. Korrigerings-ID är MDVA-42790. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.5.
