...
description: Korrigeringen ACSD-45520 åtgärdar ett problem där alternativen för färgrutor inte är förvalda på produktinformationssidan när en användare redigerar konfigurerbara produkter från kundvagnen. Den här korrigeringen är tillgänglig när [QPT-verktyget (Quality Patches Tool)](https://experienceleague.adobe.com/sv/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.17 är installerat. Korrigerings-ID är ACSD-45520. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.6.
feature: Products
role: Admin
