...
Korrigeringen ACSD-47106 åtgärdar ett problem där ett värde inte kan sparas i ett nytt anpassat attribut på en företagsskapandesida. Den här korrigeringen är tillgänglig när [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.22 är installerad. Korrigerings-ID är ACSD-47106. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.6.
