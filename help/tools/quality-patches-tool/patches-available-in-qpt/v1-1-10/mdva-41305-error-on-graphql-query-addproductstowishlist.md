...
description: MDVA-41305-korrigeringen löser problemet där användare får ett fel i GraphQL-frågan "addProductsToWishlist" för konfigurerbara produkter. Den här korrigeringen är tillgänglig när [QPT-verktyget (Quality Patches Tool)](https://experienceleague.adobe.com/sv/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.10 är installerat. Korrigerings-ID är MDVA-41305. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.5.
