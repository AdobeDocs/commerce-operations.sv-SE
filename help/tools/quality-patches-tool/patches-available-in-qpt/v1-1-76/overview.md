...
1. **[ACSD-69203](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)**: Korrigerar ett fel där widgeten **[!UICONTROL Products List]** returnerar felaktiga resultat när flera kategorier listades i kategorivillkoret.
