---
title: 'Översikt: [!DNL Quality Patches Tool] (QPT) v1.1.74'
description: I det här underavsnittet finns en detaljerad beskrivning av de problem som åtgärdats av de korrigeringar som finns i  [!DNL Quality Patches Tool] (QPT) v1.1.74.
...
# Översikt: [!DNL Quality Patches Tool] (QPT) v1.1.74
...
1. **ACSD-68499**: Korrigerade ett problem där GraphQL `updateCartItems`-mutationen returnerar ett lyckat svar när kvantiteter som överskrider det tillgängliga lagret uppdateras, vilket ger upphov till uppblåsta mängder och summor.
