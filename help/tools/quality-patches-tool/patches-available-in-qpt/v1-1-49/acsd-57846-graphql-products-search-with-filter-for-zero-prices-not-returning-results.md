...
Korrigeringen ACSD-57846 åtgärdar ett problem där filtrering av produkter från noll leder till en felaktig begäran till [!DNL OpenSearch] och inte returnerar några resultat. Den här korrigeringen är tillgänglig när [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.49 är installerad. Korrigerings-ID är ACSD-57846. Observera att problemet har åtgärdats i Adobe Commerce 2.4.7.
