---
title: 'ACSD-51120: Cacheminnet för begäran av GraphQL GET har inte rensats för CMS-sidor som innehåller CMS-block'
...
1. Hämta CMS-sidan med den aktuella GraphQL-frågan med hjälp av en GET-förfrågan:
...
1. Hämta CMS-sidan igen med den angivna GraphQL-frågan med hjälp av en GET-förfrågan.
