...
1. **ACSD-68490**: Korrigerar problemet där knappen **[!UICONTROL Add New Attribute]** visas för en begränsad administratörsanvändare när en konfigurerbar produkt skapas.
