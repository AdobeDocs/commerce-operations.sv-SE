...
Korrigeringen ACSD-52613 åtgärdar ett problem där Adobe Commerce-problemet där cache och index uppdateras när `Inventory_source` inte gör några uppdateringar av [!DNL REST API] objekt. Den här korrigeringen är tillgänglig när [!DNL Quality Patches Tool (QPT)] 1.1.37 har installerats. Korrigerings-ID är ACSD-52613. Observera att problemet har åtgärdats i Adobe Commerce 2.4.7.
