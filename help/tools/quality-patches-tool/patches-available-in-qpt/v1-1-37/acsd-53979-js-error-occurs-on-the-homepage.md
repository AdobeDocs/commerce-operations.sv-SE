...
Korrigeringen ACSD-53979 åtgärdar ett problem där ett JavaScript-fel inträffar på hemsidan om välkomstmeddelandet innehåller ett enkelt citattecken. Den här korrigeringen är tillgänglig när [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/sv/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.37 är installerad. Korrigerings-ID är ACSD-53979. Observera att problemet är planerat att åtgärdas i Adobe Commerce 2.4.7.
