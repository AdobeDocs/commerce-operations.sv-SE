...
*POP* i det här sammanhanget avser en POP (Point of Presence) som är konfigurerad att fungera som en pool för cachelagring. Se [Närvaropunkter](https://developer.fastly.com/learning/concepts/pop/).
