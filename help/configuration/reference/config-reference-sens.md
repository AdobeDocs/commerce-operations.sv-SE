...
| Region/delstat | `shipping/origin/region_id` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |  | ![Känslig](/help/assets/configuration/cloud-sens.png) |
...
| Gateway XML-URL | `carriers/ups/gateway_xml_url` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |  | ![Känslig](/help/assets/configuration/cloud-sens.png) |
