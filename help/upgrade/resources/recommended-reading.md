      ...
      <td><strong>Funktioner och oberoende tjänster</strong>
        <p>Upptäck innovativa Commerce-tjänster som finns som Adobe Commerce-tillägg och var du kan få dem.</p>
          <ul>
            ...
            <li><a href="https://commercemarketplace.adobe.com//magento-payment-services.html">Betalningstjänster</a></li>
            <li><a href="https://commercemarketplace.adobe.com//magento-product-recommendations.html">Produktrekommendationer</a></li>
          </ul>
      </td>
    </tr>
    <tr>
      <td><strong>Uppgraderingsresurser</strong>
        <p>Skydda butiken och arbeta effektivt. Förbered dig för uppgraderingen av Adobe Commerce genom att läsa Adobe utförliga tekniska dokumentation.</p>
          <ul>
            ...
            <li><a href="https://experienceleague.adobe.com/docs/commerce-learn/tutorials/upgrade-workshop.html">2.4 Technical Upgrade Workshop - inspelning</a></li>
