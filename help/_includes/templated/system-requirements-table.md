...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          8.0.mysql_aurora.3.11.1 eller senaste
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
          ElastiCache 7.1 for Redis OSS (enhanced). Valkey 8 är tillgängligt.
      </td>
    </tr>
    <tr>
      <td><span class="uicontrol">[!DNL AWS OpenSearch]</span></td>
      <td>
          3.1 eller senaste tillgängliga
      </td>
    </tr>
  </tbody>
</table>
...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          8.0.mysql_aurora.3.09 eller senaste tillgängliga
      </td>
      <td>
          8.0.mysql_aurora.3.09 eller senaste tillgängliga
      </td>
    ...
    <tr>
      ...
      <td>
          ElastiCache version 7.1 för Redis OSS (förbättrat). Valkey 8 är tillgängligt.
      </td>
      <td>
...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          2.17 eller senaste tillgängliga
      </td>
      <td>
          2.19 eller senaste tillgängliga
      </td>
