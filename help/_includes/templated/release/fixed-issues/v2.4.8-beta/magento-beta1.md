...
---
# Versionsinformation om Magento Open Source (v2.4.8-beta1)

## Högdagrar i v2.4.8-beta1

Följande 49 markeringar gäller för Magento Open Source 2.4.8.
...
Vi har åtgärdat 253 problem i Magento Open Source 2.4.8 Core-koden. En deluppsättning av de åtgärdade problemen som ingår i den här versionen beskrivs nedan.
