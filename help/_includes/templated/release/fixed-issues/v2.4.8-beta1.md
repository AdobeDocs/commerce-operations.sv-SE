...
Vi har åtgärdat 279 problem i Adobe Commerce 2.4.8 Core-koden. En deluppsättning av de åtgärdade problemen som ingår i den här versionen beskrivs nedan.
...
* _AC-12268_:
   * _Åtgärda problem_: Undersök prestandaproblemet efter att ha uppgraderat dispositionsberoenden för gänge/flygsystem till den senaste versionen
...
* _AC-12715_:
   * _Korrigera anteckning_: Undersök laminas-dispositionsberoenden som uppgraderar till den senaste versionen
