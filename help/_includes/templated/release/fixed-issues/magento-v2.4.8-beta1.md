...
Vi har åtgärdat 231 problem i Magento Open Source 2.4.8-kärnkoden. En deluppsättning av de åtgärdade problemen som ingår i den här versionen beskrivs nedan.
...
* _AC-11673_:
   ...
   * _GitHub-kodbidrag_: Kontrollera att den senaste versionen av php-amqplib/php-amqplib ska vara kompatibel
...
* _AC-12022_:
   ...
   * _GitHub-kodbidrag_: Systemet har uppdaterats för att använda den senaste större versionen av biblioteket &quot;monolog/monolog&quot;, vilket garanterar kompatibilitet och förbättrade prestanda. Tidigare använde systemet en föråldrad version av &quot;monolog/monolog&quot;-biblioteket som kunde ha orsakat potentiella problem och begränsningar.
* _AC-12023_:
...
* _AC-12024_:
   ...
   * _GitHub-problem_: &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _GitHub-kodbidrag_: Uppgradera jQuery/validera biblioteksberoende till den senaste delversionen
* _AC-12025_:
   * _Korrigera anteckning_: Systemberoende för uppgradering av stund.js till den senaste mindre versionen
   * _GitHub-problem_: &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _GitHub-kodbidrag_: Systemberoende för uppgradering av stund.js till den senaste delversionen
* _AC-12267_:
   ...
   * _GitHub-problem_: &lt;<https://github.com/magento/magento2/commit/672a2e61>>
   * _GitHub-kodbidrag_: Kontrollera att den senaste versionen av colinblöenhour/php-redis-session-abstract v2.0.0 är kompatibel med Adobe commerce
...
* _AC-8714_:
   * _Korrigera anteckning_: lack 7.3 - Underkategorier, länkar/alternativ i standardkategorin visas inte på förstasidan i Store
   * _GitHub-problem_: &lt;<https://github.com/magento/magento2/commit/d1c335aa>, &lt;https://github.com/magento/magento2/ (Internal, Unmerged)>>
   * _GitHub-kodbidrag_: Startsidor för Storefront visar nu standardunderkategorier för kategorier som förväntat. Tidigare hade kunderna bara åtkomst till underkategorier via URL.
...
* _AC-9712_: https://github.com/magento/magento2/issues/37841
   ...
   * _GitHub-problem_: &lt;&lt;https://github.com/magento/magento2/ (Internal, Unmerged)>>
   * _GitHub-kodbidrag_: Korrigera skillnaden i mindre kompilering mellan php- och nodejs-biblioteket (grunt)
...
* _AC-12128_:
   * _Korrigera anteckning_: [Cloud] Prototype.js - säkerhetsrisk CVE-2020-27511
   * _GitHub-problem_: &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _GitHub-kodbidrag_: Säkerhetsluckan CVE-2020-27511 bör åtgärdas
...
* _AC-12950_: Uppdateringsintervall 7.3.0 i Composer.json och Ta bort från filer från index 7
   * _Korrigera anteckning_: Gör TinyMCE 7.x till en version som stöds för Adobe Commerce 2.4.8-beta1
   * _GitHub-kodbidrag_: &lt;https://github.com/magento/magento2/ (Internal, Unmerged)>
