...
* __Uppgradera ligan/flygsystemet Composer-beroenden genom att uppgradera till den senaste versionen__
...
* __Undersök de senaste versionerna av php-amqplib/php-amqplib__
...
* __Rensning av jQuery/fileuploader-css efter migrering till uppy-biblioteket__
...
* __Lägg till kompatibilitet med MySQL 8.4 LTS för Magento CE__
  _AC-11995 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/672a2e61>)_
* __Rensa ExtJs-mappen efter migrering till jsTree-biblioteket__
...
* __Uppgradera systemberoende för monolog/monolog till den senaste större versionen__
Systemet har uppdaterats för att använda den senaste större versionen av biblioteket &quot;monolog/monolog:^3.x&quot;, vilket säkerställer kompatibilitet och förbättrade prestanda. Tidigare använde systemet en föråldrad version av &quot;monolog/monolog&quot;-biblioteket som kunde ha orsakat potentiella problem och begränsningar.
  _AC-12022 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/edcd0dcc>)_
* __Uppgradera wikimedia/less.php till den senaste större versionen__
...
* __Uppgradera jQuery/validera biblioteksberoendet till den senaste delversionen__
...
* __Systemberoende för uppgradering av stund.js till den senaste delversionen__
...
* __Prenumerantoptimering - PhpUnit10__
  _AC-12165 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/90e25b6b>)_
* __Stöd för återanslutningsförsök för Redis-sessioner och kompatibelt med colinvåra_tim/php-redis-session-abstract v2.0.0__
...
* __Undersök automatiseringstester av fel med MySQL 8.4 LTS__
  _AC-12576 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/672a2e61>)_
* __Lägg till kompatibilitet med MariaDB 11.4 LTS för EE__
MariaDB 11.4-stöd har lagts till med Adobe Commerce och tillägg
  _AC-12595 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/b34c0a75>)_
* __Uppdatera beroenden för laminas-dispositionen genom att uppgradera till den senaste versionen__
...
* __Undersök enhetstestfel på grund av att korrigeringsfilen för phpunit uppdaterades under komponentuppgradering__
  _AC-12823 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/b34c0a75>)_
* __[Del 1] - Uppdatera alla js-bibliotek och npm-beroende med den senaste tillgängliga versionen__
...
* __[Funktionsförfrågan] Kunden föreslår att knappen Skicka kommentarer på sidan Beställningsinformation är förvirrande och bör ändras till något annat__
...
* __Ange indexerare visas som standard med statusen Klart när en ny version av Adobe Commerce installeras__
...
* __Vid en befintlig Magento-installation när en indexerarmodul från tredje part installeras ställs indexerare in som standard i uppdateringsschemat.__
Alla nya indexerare är som standard i läget [ Uppdatera efter schema ] . Tidigare var standardläget [Uppdatera vid Spara]. Samma sak med anpassade indexerare.
  _AC-11421 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/71432aeb>)_
* Alternativen för __Elasticsearch 7 och 8 bör finnas med i konfigurationen Borttagen i Admin.__
...
* __Lägg till textanteckning när alternativet Elasticsearch har valts i Admin Configuration__
...
* __Leverera prestandaförbättringspatch för operationer på nivån till 2.4.8__
...
* __Ta bort alla Adobe konfidentiella copyrightmeddelanden från Magento Open Source-databaserna__
...
* __[2.4.8-beta1] TinyMCE 5-migrering till TinyMCE 7__
...
* __[2.4.8-beta1] TinyMCE 5-migrering till TinyMCE 7 Page Builder__
TinyMCE 5 har migrerats till TinyMCE 7.3.0 till en version som stöds för Adobe Commerce, som tidigare använde 5.10.2, som var inaktuell och rapporterad som säkerhetsrisk
  _AC-12825 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/edcd0dcc>)_
* __[2.4.8-beta1] TinyMCE 5-migrering till TinyMCE 7 - Magento2-infra - förbjudna ord__
TinyMCE 5 har migrerats till TinyMCE 7.3.0 till en version som stöds för Adobe Commerce, som tidigare använde 5.10.2, som var inaktuell och rapporterad som säkerhetsrisk
  _AC-12844 - [GitHub-kodbidrag](<https://github.com/magento/magento2/commit/edcd0dcc>)_
* __Kräv uppgradering.js till den senaste versionen, 2.3.7 (säkerhetslucka, CVE-2024-3899)__
