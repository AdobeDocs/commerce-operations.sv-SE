...
Följande referensdokumentation genereras från `composer.lock` och omfattar de paket som ingår i Magento Open Source 2.4.6-beta2.

## Beroenden

`magento/product-community-edition 2.4.6-beta2` har följande beroenden:
