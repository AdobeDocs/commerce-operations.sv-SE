...
Följande referensdokumentation genereras från `composer.lock` och omfattar de paket som ingår i Adobe Commerce 2.4.7-beta1.

## Beroenden

`magento/product-enterprise-edition 2.4.7-beta1` har följande beroenden:
