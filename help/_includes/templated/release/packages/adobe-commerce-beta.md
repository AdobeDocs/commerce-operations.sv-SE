...
Följande referensdokumentation genereras från `composer.lock` och innehåller de paket som ingår i Adobe Commerce 2.4.7-beta3.

## Beroenden

`magento/product-enterprise-edition 2.4.7-beta3` har följande beroenden:
